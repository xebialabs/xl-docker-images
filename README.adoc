...
=== Test New Docker Images with xl-up

To test New Docker Images locally in our CI/CD setups you need to make a PR and add label `test-xl-up-pr` in your github PR, then this pr will run xlup using XL new docker images againing Minikube cluster.