...
docker-compose -f docker-compose-xld-ha-slim-workers.yaml up --scale xl-deploy-worker=2 -d || exit

# Print out the status
docker-compose -f docker-compose-xld-ha.yaml -f docker-compose-xld-ha-slim-workers.yaml ps || exit
