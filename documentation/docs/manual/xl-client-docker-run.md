...
```
**Note:** In our example, we are mounting config from local volumes, for reading the xl-release.lic file from file Path.
...
```
**Note:** In our example, we are mounting remote runner package from local volumes.
...
* xl-client will be running in a docker container with the name "xl-client".
* We can connect to the container and exec kube install/clean command.
eg :
```shell
[ishwarya@worker01 Downloads] $ docker exec -it xl-client /bin/sh
~/xl-client $ ./xl kube install --answers config/answer.yaml
...
? Select source of the repository keystore: generate
	...
	| EnableRabbitmq                 | true                                               |
	| ExternalOidcConf               | external: false                                    |
	| GenerationDateTime             | 20230405-060959                                    |
	| ImageNameRelease               | xl-release                                         |
	| ImageRegistryType              | default                                            |
	| ImageTag                       | 22.3.8                                             |
	...
	| IsCustomImageRegistry          | false                                              |
	| K8sSetup                       | AzureAKS                                           |
	| KeystorePassphrase             | 23G9wEB0BGiPUYFD                                   |
	| License                        | LS0tIExpY2Vuc2UgLS0tCkxpY2Vuc2UgdmVyc2lvbjogNApQ.. |
	| LicenseFile                    | /opt/xebialabs/xl-client/config/xl-release.lic     |
	| LicenseSource                  | file                                               |
	| Namespace                      | default                                            |
	...
	| RabbitmqPvcSize                | 1                                                  |
	| RabbitmqReplicaCount           | 1                                                  |
	| RabbitmqStorageClass           | xlr-operator-azurefile                             |
	| RepositoryKeystoreSource       | generate                                           |
	| RepositoryName                 | xebialabs                                          |
	| ServerType                     | dai-release                                        |
	| ShortServerName                | xlr                                                |
	| StorageClass                   | xlr-operator-azurefile                             |
	| UseCustomNamespace             | true                                               |
	| XlrReplicaCount                | 1                                                  |
	 -------------------------------- ----------------------------------------------------
? Do you want to proceed to the deployment with these values? Yes
For current process files will be generated in the: digitalai/dai-release/default/20230405-060959/kubernetes
Generated answers file successfully: digitalai/generated_answers_dai-release_default_install-20230405-060959.yaml 
Starting install processing.
Created keystore digitalai/dai-release/default/20230405-060959/kubernetes/repository-keystore.jceks
Skip creating namespace default, already exists
Using custom resource name dai-xlr-default
Generated files successfully for AzureAKS installation.
Applying resources to the cluster!
? Do you want to replace the resource clusterrole/default-xlr-operator-proxy-role with specification from file
digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-digital-proxy-role.yaml: Yes
Applied resource clusterrole/default-xlr-operator-proxy-role from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-digital-proxy-role.yaml
? Do you want to replace the resource clusterrole/default-xlr-operator-manager-role with specification from file
digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-manager-role.yaml: Yes
Applied resource clusterrole/default-xlr-operator-manager-role from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-manager-role.yaml
? Do you want to replace the resource clusterrole/default-xlr-operator-metrics-reader with specification from file
digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-metrics-reader.yaml: Yes
Applied resource clusterrole/default-xlr-operator-metrics-reader from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/cluster-role-metrics-reader.yaml
Applied resource service/xlr-operator-controller-manager-metrics-service from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/controller-manager-metrics-service.yaml
Applied resource customresourcedefinition/digitalaireleases.xlr.digital.ai from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/custom-resource-definition.yaml
Applied resource deployment/xlr-operator-controller-manager from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/deployment.yaml
Applied resource role/xlr-operator-leader-election-role from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/leader-election-role.yaml
Applied resource rolebinding/xlr-operator-leader-election-rolebinding from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/leader-election-rolebinding.yaml
? Do you want to replace the resource clusterrolebinding/default-xlr-operator-manager-rolebinding with specification from file
digitalai/dai-release/default/20230405-060959/kubernetes/template/manager-rolebinding.yaml: Yes
Applied resource clusterrolebinding/default-xlr-operator-manager-rolebinding from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/manager-rolebinding.yaml
? Do you want to replace the resource clusterrolebinding/default-xlr-operator-proxy-rolebinding with specification from file
digitalai/dai-release/default/20230405-060959/kubernetes/template/proxy-rolebinding.yaml: Yes
Applied resource clusterrolebinding/default-xlr-operator-proxy-rolebinding from the file digitalai/dai-release/default/20230405-060959/kubernetes/template/proxy-rolebinding.yaml
Applied resource digitalairelease/dai-xlr-default from the file digitalai/dai-release/default/20230405-060959/kubernetes/dai-release_cr.yaml
Install finished successfully!
~/xl-client $
